...
const ERC1155Edition = () => {
  return (
    <>
      ...
      <div className="mb-4 m-4">
        <div className="flex justify-between">
          ...
          <Switch
            ...
            className={`${
              zoraEnabled.isChargeForMint ? "bg-[#e1f16b]" : "bg-gray-200"
          ...
          >
            <span
              className={`${
                zoraEnabled.isChargeForMint ? "translate-x-6" : "translate-x-1"
      ...
      <div className={`${!zoraEnabled.isChargeForMint && "hidden"} mx-4`}>
        <div className="flex">
        ...
        {zoraStatesError.isChargeForMintError && (
          <InputErrorMsg message={zoraStatesError.chargeForMintErrorMessage} />
        )}
      </div>
      ...
      <div className={`${!zoraEnabled.isRoyaltySplits && "hidden"}`}>
        <div className="mx-4">
          {zoraEnabled.royaltySplitRecipients.map((recipient, index) => {
            return (
              <>
                <div
                  key={index}
          ...
          {zoraStatesError.isRoyaltySplitError && (
            <InputErrorMsg message={zoraStatesError.royaltySplitErrorMessage} />
          )}
      ...
      {currentTab === "ERC1155" && (
        <>
          <div className="mb-4 m-4">
            <div className="flex justify-between">
              ...
              <Switch
                ...
                className={`${
                  zoraEnabled.isLimitedEdition ? "bg-[#e1f16b]" : "bg-gray-200"
                } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
              >
                <span
                  className={`${
          ...
          <div
            className={`${!zoraEnabled.isLimitedEdition && "hidden"} ml-4 mr-4`}
          >
        ...
        <div className="flex justify-between">
          ...
          <Switch
            ...
            onChange={() =>
              setZoraEnabled({
                ...zoraEnabled,
                isMintLimitPerAddress: !zoraEnabled.isMintLimitPerAddress,
              })
            }
            className={`${
              zoraEnabled.isMintLimitPerAddress ? "bg-[#e1f16b]" : "bg-gray-200"
            } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
          >
            <span
              className={`${
      ...
      {currentTab === "ERC721" && (
        <>
          <div className="mb-4 m-4">
            <div className="flex justify-between">
              ...
              <Switch
                ...
                className={`${
                  zoraEnabled.isRoyaltyPercent ? "bg-[#e1f16b]" : "bg-gray-200"
                } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
              >
                <span
                  className={`${
          ...
          <div className={`${!zoraEnabled.isRoyaltyPercent && "hidden"} mx-4`}>
            {/* <div className="flex"> */}
            <div className="flex flex-col py-2">
              <NumberInputBox
                min={"1"}
      ...
      {currentTab === "ERC721" && (
        <>
          <div className="mb-4 m-4">
            <div className="flex justify-between">
              ...
              <Switch
                ...
                className={`${
                  zoraEnabled.isMaxSupply ? "bg-[#e1f16b]" : "bg-gray-200"
                } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
              >
                <span
                  className={`${
                    zoraEnabled.isMaxSupply ? "translate-x-6" : "translate-x-1"
                  } inline-block h-4 w-4 transform rounded-full bg-white transition-transform`}
                />{" "}
              </Switch>
            </div>
          ...
          <div className={`${!zoraEnabled.isMaxSupply && "hidden"} mx-4`}>
            {/* <div className="flex"> */}
            <div className="flex flex-col py-2">
              <NumberInputBox
                min={"1"}
            ...
            {zoraStatesError.isMaxSupplyError && (
              <InputErrorMsg message={zoraStatesError.maxSupplyErrorMessage} />
            )}
          </div>
        </>
      )}
          ...
          <div className="mb-4 m-4">
            <div className="flex justify-between">
              ...
              <Switch
                ...
                className={`${
                  zoraEnabled.isScheduleMint ? "bg-[#e1f16b]" : "bg-gray-200"
                } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
              >
                <span
                  className={`${
            ...
            <div className="w-4/5 opacity-75"> Schedule your mint </div>
          </div>
          ...
          <div className="mb-4 m-4">
            <div className="flex justify-between">
              ...
              <Switch
                ...
                className={`${
                  zoraEnabled.isPresaleSchedule ? "bg-[#e1f16b]" : "bg-gray-200"
                } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
              >
                <span
                  className={`${
        ...
        <>
            ...
            <div className="flex justify-between">
              ...
              <Switch
                ...
                onChange={() =>
                  setZoraEnabled({
                    ...zoraEnabled,
                    isPublicsaleSchedule: !zoraEnabled.isPublicsaleSchedule,
                  })
                }
                className={`${
          ...
          >
            ...
            {zoraStatesError.isPublicsaleScheduleError && (
              <InputErrorMsg
                message={zoraStatesError.publicsaleScheduleErrorMessage}
              />
            )}
          </div>
        </>
      ...
      <div className="mb-4 m-4">
        <div className="flex justify-between">
          <h2 className="text-lg mb-2"> Customize Contract Details </h2>
          <Switch
            ...
            className={`${
              zoraEnabled.isContractDetails ? "bg-[#e1f16b]" : "bg-gray-200"
            } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#e1f16b] focus:ring-offset-2`}
          >
            <span
              className={`${
      ...
      <div
        className={`${!zoraEnabled.isContractDetails && "hidden"} ml-4 mr-4`}
      >
        <div className="flex flex-col w-full py-2">
          ...
          {zoraStatesError.isSellerFeeError && (
            <InputErrorMsg message={zoraStatesError.sellerFeeErrorMessage} />
          )}
        </div>
      </div>
